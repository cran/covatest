...
#' tested is \eqn{$H_0: C(h,u) - C(h,-u)=0$}{H_0: C(h,u) - C(h,-u) = 0}
#'
...
#' \eqn{$H_0: C(h, u)/C(h, 0) - C(0, u)/C(0,0)=0$}{H_0: C(h, u)/C(h, 0) - C(0, u)/C(0,0) = 0}
#'
...
#' the generic null hypothesis is: \eqn{$H_0: Af(G)=0$}{H_0: Af(G) = 0}
#' }
